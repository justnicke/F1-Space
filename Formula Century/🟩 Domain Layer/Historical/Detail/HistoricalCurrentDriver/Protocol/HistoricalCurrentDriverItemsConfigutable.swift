//
//  HistoricalCurrentDriverItemsConfigutable.swift
//  Formula Century
//
...
protocol HistoricalCurrentDriverItemsConfigutable: DriverStandingsItemsCounterable, HistoricalCurrentDriverProperty {
...
extension HistoricalCurrentDriverItemsConfigutable {
    func getTeammate(from results: [[ResultF1]]) -> [String] {
